...
int _ssh_buffer_pack(struct ssh_buffer_struct *buffer,
                     ...
                     size_t argc,
                     ...);
#define ssh_buffer_pack(buffer, format, __VA_ARGS__) _ssh_buffer_pack((buffer), (format), __VA_NARG__(__VA_ARGS__), __VA_ARGS__, SSH_BUFFER_PACK_END)
...
int _ssh_buffer_unpack(struct ssh_buffer_struct *buffer,
                       ...
                       size_t argc,
                       ...);
#define ssh_buffer_unpack(buffer, format, __VA_ARGS__) _ssh_buffer_unpack((buffer), (format), __VA_NARG__(__VA_ARGS__), __VA_ARGS__, SSH_BUFFER_PACK_END)

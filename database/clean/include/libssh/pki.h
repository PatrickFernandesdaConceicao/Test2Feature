...
#define MAX_PUBKEY_SIZE 0x100000
#define MAX_PRIVKEY_SIZE 0x400000
...
#else
    void *ecdsa;
#endif /* HAVE_OPENSSL_EC_H */ /* HAVE_OPENSSL_EC_H */
#endif /* HAVE_LIBGCRYPT */ /* HAVE_LIBGCRYPT */
#ifdef HAVE_OPENSSL_ED25519
...
#define is_ecdsa_key_type(t) ((t) >= SSH_KEYTYPE_ECDSA_P256 && (t) <= SSH_KEYTYPE_ECDSA_P521)


#define is_cert_type(kt) ((kt) == SSH_KEYTYPE_DSS_CERT01 || (kt) == SSH_KEYTYPE_RSA_CERT01 || ((kt) >= SSH_KEYTYPE_ECDSA_P256_CERT01 && (kt) <= SSH_KEYTYPE_ED25519_CERT01))

...
#define SSH_KNOWNHOSTS_ENTRY_FREE(e) do { if ((e) != NULL) { ssh_knownhosts_entry_free(e); e = NULL; } } while(0)
...
#define SSH_STRING_FREE(x) do { if ((x) != NULL) { ssh_string_free(x); x = NULL; } } while(0)
...
#define SSH_STRING_FREE_CHAR(x) do { if ((x) != NULL) { ssh_string_free_char(x); x = NULL; } } while(0)
...
#define SSH_BUFFER_FREE(x) do { if ((x) != NULL) { ssh_buffer_free(x); x = NULL; } } while(0)

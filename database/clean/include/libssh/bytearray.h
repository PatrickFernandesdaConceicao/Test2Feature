...
#define PUSH_LE_U8(data, pos, val) (_DATA_BYTE(data, pos) = ((uint8_t)(val)))


#define PUSH_LE_U16(data, pos, val) (PUSH_LE_U8((data), (pos), (uint8_t)((uint16_t)(val) & 0xff)), PUSH_LE_U8((data), (pos) + 1, (uint8_t)((uint16_t)(val) >> 8)))
...
#endif /* _BYTEARRAY_H */ /* _BYTEARRAY_H */
